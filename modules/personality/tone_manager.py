...
async def process_message(user_id: int, text: str) -> str:
    base_prompt = (
        ...
        "หากมีคนถามว่า 'พี่หลามคือใคร' หรือถามคล้ายกัน เช่น 'พี่หลามคืออะไร' "
        "ให้ตอบสั้น ๆ ว่าเป็นบอทผู้ช่วยที่คุยเป็นเพื่อนได้ทุกเรื่อง ไม่ต้องอธิบายแบบ Wikipedia หรืออ้างอิงจากเว็บไซต์ภายนอก\n\n"
    )
